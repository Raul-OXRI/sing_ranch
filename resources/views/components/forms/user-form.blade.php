...
<div>
    ...
    <div class="mb-4">
        ...
        <input type="text" class="mt-1 w-1/2 rounded-lg  px-3 py-2" name="last_name" id="last_name" required>
    </div>
    <div class="mb-4">
        <label for="username" class="text-sm font-medium w-1/2">Nombre de usuario: </label>
        <input type="text" class="mt-1 w-1/2 rounded-lg  px-3 py-2" name="username" id="username" required>
    </div>
    <div class="mb-4">
        <label for="email" class="text-sm font-medium w-1/2">Correo electrónico: </label>
        <input type="email" class="mt-1 w-1/2 rounded-lg  px-3 py-2" name="email" id="email" required>
    </div>
    <div class="mb-4">
        <label for="password" class="text-sm font-medium w-1/2">Contraseña: </label>
        <input type="password" class="mt-1 w-1/2 rounded-lg  px-3 py-2" name="password" id="password" required>
    </div>
    <div class="mb-4">
