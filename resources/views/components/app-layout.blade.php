...
<body class="min-h-screen flex flex-col">
    ...
    <header>
        <div class="navbar bg-base-100 shadow-sm">
            ...
            <div class="navbar-center">
                <a class="btn btn-ghost text-lg sm:text-4xl" href="{{ route('Auth.dashboard') }}">Finca el suspiro</a>
            </div>
            <div class="navbar-end">
                <ul class="dropdown-content">
                    <li><a href="{{ route('Auth.logout') }}" class="btn btn-circle"><i
                            class="fa-light fa-arrow-right-from-bracket text-sm sm:text-xl"></i></a></li>
                </ul>
            </div>
        </div>
    </header>
    ...
    <footer
        ...
        <nav class="text-center sm:mt-9">
            <h6 class="text-xl font-bold mb-2 sm:text-3xl font-bold">Contacto</h6>
